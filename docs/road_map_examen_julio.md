...
| :----: | :-------------------- | :------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|  [ ]   | **Día 1**<br>(29 jun) | **k-NN y Bases de RRNN**                    | <ul><li>[X] Calcular distancias k-NN (Euclídea, Manhattan, Hamming).</li><li>[X] Normalizar atributos (mín-máx y tipificación).</li><li>[ ] Entrenar un perceptrón a mano.</li><li>[ ] Entender funciones de activación (Sigmoide, ReLU, Tanh).</li></ul>                             |
