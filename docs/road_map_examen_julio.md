...
|  [ ]   | **Día 3**<br>(1 jul)  | **Proc. del Lenguaje Natural**              | <ul><li>[X] Vectorizar textos (Bolsa de palabras y matriz tf-idf).</li><li>[X] Aplicar Naive Bayes (con Laplace) y k-NN (similitud coseno).</li><li>[ ] Calcular probabilidades con n-gramas e interpolación.</li><li>[ ] Calcular la perplejidad de un modelo de lenguaje.</li></ul> |
