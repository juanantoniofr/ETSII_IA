...
| :----: | :-------------------- | :------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|  [X]   | **Día 1**<br>(29 jun) | **k-NN y Bases de RRNN**                    | <ul><li>[X] Calcular distancias k-NN (Euclídea, Manhattan, Hamming).</li><li>[X] Normalizar atributos (mín-máx y tipificación).</li><li>[X] Entrenar un perceptrón a mano.</li><li>[X] Entender funciones de activación (Sigmoide, ReLU, Tanh).</li></ul>                             |
|  [X]   | **Día 2**<br>(30 jun) | **Redes Neuronales<br>(Núcleo matemático)** | <ul><li>[X] Realizar un paso de _forward propagation_.</li><li>[X] Calcular funciones de coste (MSE y Entropía Cruzada).</li><li>[X] Realizar la retropropagación (_backpropagation_) a mano.</li><li>[X] Actualizar pesos con descenso estocástico por el gradiente.</li></ul>       |
|  [X]   | **Día 3**<br>(1 jul)  | **Proc. del Lenguaje Natural**              | <ul><li>[X] Vectorizar textos (Bolsa de palabras y matriz tf-idf).</li><li>[X] Aplicar Naive Bayes (con Laplace) y k-NN (similitud coseno).</li><li>[X] Calcular probabilidades con n-gramas e interpolación.</li><li>[X] Calcular la perplejidad de un modelo de lenguaje.</li></ul> |
|  [X]   | **Día 4**<br>(2 jul)  | **Planificación Automática**                | <ul><li>[X] Modelar dominios en STRIPS (Precondiciones, Add/Del).</li><li>[X] Trazar la búsqueda con Dijkstra y A\*.</li><li>[X] Extraer planes relajados ignorando las listas de borrado.</li><li>[X] Calcular heurísticas a mano ($h^+$, $h^{max}$ y $h^{add}$).</li></ul>          |
|  [X]   | **Día 5**<br>(3 jul)  | **A. por Refuerzo (Parte I)**               | <ul><li>[X] Formular un MDP y las ecuaciones de Bellman.</li><li>[X] Realizar 1-2 pasos del algoritmo de Iteración de Valores.</li><li>[X] Realizar un paso del algoritmo de Iteración de Políticas.</li></ul>                                                                        |
|  [X]   | **Día 6**<br>(4 jul)  | **A. por Refuerzo (Parte II)**              | <ul><li>[X] Entender las políticas $\epsilon$-voraz (exploración vs explotación).</li><li>[X] Simular el método de Montecarlo (1ª visita y cada visita).</li><li>[X] Actualizar una tabla $Q(s,a)$ ejecutando Q-Learning.</li></ul>                                                   |
